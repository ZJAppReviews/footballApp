...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row < 8){
        MainViewController* center = [[[MainViewController alloc]initWithStyle:UITableViewStyleGrouped]autorelease];

         nav = [[[UINavigationController alloc] initWithRootViewController:center]autorelease];
    }else if(indexPath.row == 8){
        
        WebViewController* web = [[[WebViewController alloc]initWithURLString:@"http://www.baidu.com"]autorelease];
         nav = [[[UINavigationController alloc] initWithRootViewController:web]autorelease];
    }else if(indexPath.row == 7){
        WebViewController* web = [[[WebViewController alloc]initWithURLString:@"http://www.google.com"]autorelease];
        nav = [[[UINavigationController alloc] initWithRootViewController:web]autorelease];
    }else if(indexPath.row == 6){
        WebViewController* web = [[[WebViewController alloc]initWithURLString:@"http://www.163.com"]autorelease];
        nav = [[[UINavigationController alloc] initWithRootViewController:web]autorelease];
    }
